...
public class SynthEventServiceImplIntegrationTest extends AbstractEntityRecordItemListenerTest {
    ...
    void TokenDeleteApproval () {
        ...
        assertThat(contractLogRepository.findAll())
                .hasSize(transferLists.size() + 3); //add plus two, because we have two approve allowances and one delete allowance
    }
    ...
    private static Stream<Arguments> provideTokenCreateArguments(TokenType tokenType) {
        ...
        List<Long> autoEnabledAccountBalances = tokenType == FUNGIBLE_COMMON ? List.of(1000000L, 0L, 0L) : List.of(0L
                , 0L, 0L);
        return Stream.of(
                SynthEventServiceImplIntegrationTest.TokenCreateArguments.builder()
