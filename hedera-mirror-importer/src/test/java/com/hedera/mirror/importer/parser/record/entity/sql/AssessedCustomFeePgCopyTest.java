...
class AssessedCustomFeePgCopyTest extends IntegrationTest {
    ...
    void copy() throws SQLException {
        ...
        assessedCustomFee1.setTransactionPayerAccountId(EntityId.of("0.0." + FEE_PAYER_1, EntityTypeEnum.ACCOUNT));
        ...
        assessedCustomFee2.setTransactionPayerAccountId(EntityId.of("0.0." + FEE_PAYER_1, EntityTypeEnum.ACCOUNT));
        ...
        assessedCustomFee3.setTransactionPayerAccountId(EntityId.of("0.0." + FEE_PAYER_2, EntityTypeEnum.ACCOUNT));
